...
export default function Login() {
    ...
    <div class="h-screen md:flex">
        <div class="relative overflow-hidden md:flex w-1/2 bg-black i justify-around items-center hidden">
            <div>
                <h1 class="text-white font-bold text-4xl font-sans">Job-IT</h1>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white">
                ...
                <p class="text-sm font-normal text-gray-600 mb-7">Welcome Back</p>
                    ...
                    <Link to ="/home"> <button type="submit" class="block w-full bg-black mt-4 py-2 rounded-2xl text-white font-semibold mb-2"> Login </button> </Link>
