...
export default function Navbar() {
    ...
    return (
        <nav className="bg-white px-2 sm:px-4 py-1 w-full z-20 sticky top-0 left-0 border-b drop-shadow-lg dark:bg-black">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="mx-auto"> <Switcher /> </div>
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                ...
                <li>
                    <Link to="/student" className="block py-2 pl-3 pr-4 text-black rounded active:text-blue-400 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-black dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-black md:dark:hover:bg-transparent dark:border-gray-700">Students</Link>
                </li>
                <li>
